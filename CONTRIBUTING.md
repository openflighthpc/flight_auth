# Contributing to FlightAuth

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to FlightAuth? Welcome! Please read this
...
You can help FlightAuth by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight_auth/issues?state=open)
...
If you find a bug - behaviour of FlightAuth code or documentation
...
[GitHub issue tracker for FlightAuth](https://github.com/openflighthpc/flight_auth/issues/new)
to report the issue.
...
We want to improve the quality of FlightAuth and good bug reports are
...
FlightAuth is Open Source and comes without warranty.
...
FlightAuth in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of FlightAuth and really improve it. The more
...
applied to FlightAuth itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight_auth). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the FlightAuth developers also have their regular
